		...
		private void dumpToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			if (GetToolStripSourceControl(sender) == modulesDataGridView)
			{
				...
				dumpFn = (reader, stream) =>
				{
					...
					MessageBox.Show("Module successfully dumped.", Constants.AppDisplayName, MessageBoxButtons.OK, MessageBoxIcon.Information);
				};
			}
			else
			{
				...
				dumpFn = (reader, stream) =>
				{
					...
					MessageBox.Show("Section successfully dumped.", Constants.AppDisplayName, MessageBoxButtons.OK, MessageBoxIcon.Information);
				};
			}
